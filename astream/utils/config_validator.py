...
def validate_config(b64config: str) -> dict:
    ...
    try:
        ...
        logger.log("WARNING", f"Config utilisateur invalide: {e}. Retour config par défaut")
        return default_config
    except Exception as e:
        logger.log("ERROR", f"Erreur validation configuration: {e}. Retour config par défaut")
        return default_config
